			...
			<c:forEach var="i" begin="${pu.startPageNum}" end="${pu.endPageNum }">
				<c:choose>
					<c:when test="${i==pu.pageNum }">
						<li class="page-item"><a class="page-link" href="/lol/member/member/messageList?pageNum=${i}"><span style='color:blue;'>[${i }]</span></a></li>
					</c:when>
					<c:otherwise>
						<li class="page-item"><a class="page-link" href="/lol/member/member/messageList?pageNum=${i}"><span style='color:gray;'>[${i }]</span></a></li>
					</c:otherwise>
				</c:choose>
			</c:forEach>
